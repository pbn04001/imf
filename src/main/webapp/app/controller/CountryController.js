...
IMFApp.controller('CountryController',['$scope','$http','$routeParams','$cacheFactory','$log',
    ...
    function ($scope,$http,$routeParams,$cacheFactory,$log,
        ...
        angular.extend(me,{
            ...
            rowClickResponsive: function(statistic,event){

                if(event.target.attributes['class'].value != "imf-graph-icon"){
                    this.rowClicked(statistic);
                }
            },
            ...
            adjustConatinerSizes: function(){
                ...
                $('#imf-country-statistics-filters').css('height', (height - 135));
                $('#imf-country-fixed-table-header-container').css('height', (height - 172));
            },
